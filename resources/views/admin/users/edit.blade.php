            ...
            <div class="bg-white overflow-hidden shadow-2xl sm:rounded-3xl border border-gray-100">
                <div class="p-8 text-gray-900">
                    <div class="flex items-center justify-between mb-8">
                        <div>
                            <h2 class="text-2xl font-black text-gray-900">Edit User</h2>
                    ...
                    <form method="POST" action="{{ route('admin.users.update', $user) }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input id="name" class="w-full border-gray-200 rounded-2xl shadow-sm focus:border-[#a4161a] focus:ring focus:ring-[#a4161a]/10 transition-all text-sm py-3 px-4" type="text" name="name" value="{{ old('name', $user->name) }}" required autofocus />
                        ...
                        <div>
                            ...
                            <input id="email" class="w-full border-gray-200 rounded-2xl shadow-sm focus:border-[#a4161a] focus:ring focus:ring-[#a4161a]/10 transition-all text-sm py-3 px-4" type="email" name="email" value="{{ old('email', $user->email) }}" required />
                        ...
                        <div class="pt-6 border-t border-gray-50">
                            <div class="mb-4">
                                ...
                                <p class="text-[10px] text-gray-500 mt-0.5">Kosongkan jika tidak ingin mengubah password.</p>
                            </div>
                            
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <!-- Password -->
                                <div>
                                    <label for="password" class="block text-[10px] font-black uppercase tracking-[0.2em] text-gray-400 mb-2">Password Baru</label>
