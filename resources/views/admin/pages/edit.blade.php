            ...
            <div class="bg-white overflow-hidden shadow-2xl sm:rounded-3xl border border-gray-100">
                <div class="p-8 text-gray-900">
                    <div class="flex justify-between items-center mb-6">
                        <h2 class="text-2xl font-black text-gray-900 tracking-tight">Edit Halaman</h2>
                    </div>
                    ...
                    <form action="{{ route('admin.pages.update', $page) }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="title" class="block w-full border-gray-200 rounded-2xl shadow-sm focus:border-[#a4161a] focus:ring focus:ring-[#a4161a]/10 transition-all text-sm py-3 px-4" type="text" name="title" :value="old('title', $page->title)" required autofocus placeholder="Masukkan judul halaman..." />
                        ...
                        <div>
                            ...
                            <textarea id="content" name="content" rows="12" class="block w-full border-gray-200 rounded-2xl shadow-sm focus:border-[#a4161a] focus:ring focus:ring-[#a4161a]/10 transition-all text-sm py-3 px-4" required placeholder="Tulis konten halaman di sini...">{{ old('content', $page->content) }}</textarea>
                        ...
                        <div class="block">
                            <label for="is_published" class="inline-flex items-center group cursor-pointer">
                                <input id="is_published" type="checkbox" class="rounded border-gray-300 text-[#a4161a] shadow-sm focus:ring-[#a4161a] transition-colors" name="is_published" value="1" {{ old('is_published', $page->is_published) ? 'checked' : '' }}>
