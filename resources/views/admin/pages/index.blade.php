                    ...
                    <div class="mb-8 bg-gray-50/50 p-6 rounded-3xl border border-gray-100 shadow-sm">
                        <form method="GET" action="{{ route('admin.pages.index') }}" class="flex flex-wrap items-end gap-4">
                            ...
                            <div class="flex-1 min-w-[240px] space-y-2">
                                <label class="text-[10px] font-black uppercase tracking-[0.2em] text-gray-400 ml-1">Cari Halaman</label>
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <a href="{{ route('admin.pages.index') }}" class="h-[42px] px-6 flex items-center bg-white text-gray-500 border border-gray-200 rounded-2xl text-[10px] font-black uppercase tracking-widest hover:bg-gray-50 transition-all">
                                    Reset
                                </a>
                                <div class="h-8 w-px bg-gray-200 mx-1"></div>
                                <a href="{{ route('admin.pages.create') }}" style="background-color: #a4161a !important;" class="h-[42px] px-6 flex items-center rounded-2xl text-[10px] font-black uppercase tracking-widest text-white hover:bg-[#ba181b] transition-all shadow-lg shadow-red-900/20">
                                    + Tambah Halaman
                                </a>
                            </div>
                        </form>
                            ...
                            <table class="w-full text-left border-collapse">
                                <thead>
                                    <tr class="bg-gray-50/80">
                                        <th class="px-6 py-4 text-[10px] font-black uppercase tracking-widest text-gray-400 border-b border-gray-100">Judul</th>
                                        <th class="px-6 py-4 text-[10px] font-black uppercase tracking-widest text-gray-400 border-b border-gray-100">Slug</th>
                                ...
                                <tbody class="divide-y divide-gray-50">
                                    @forelse($pages as $page)
                                        <tr class="hover:bg-gray-50/50 transition-colors group">
                                            <td class="px-6 py-4">
                                                <div class="text-sm font-bold text-gray-900 group-hover:text-[#a4161a] transition-colors line-clamp-1">{{ $page->title }}</div>
                                            </td>
                                            <td class="px-6 py-4">
                                                <div class="text-sm font-medium text-gray-500">{{ $page->slug }}</div>
                                            </td>
                                            ...
                                            <td class="px-6 py-4">
                                                <div class="flex items-center justify-end gap-1">
                                                    <a href="{{ route('admin.pages.edit', $page) }}" class="p-2 text-indigo-500 hover:bg-indigo-50 rounded-xl transition-all" title="Edit">
                                        ...
                                        <tr>
                                            <td colspan="5" class="px-6 py-12 text-center">
                                                <div class="flex flex-col items-center gap-2">
                                                    ...
                                                    <p class="text-sm font-bold text-gray-400">Belum ada halaman yang dibuat.</p>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforelse
