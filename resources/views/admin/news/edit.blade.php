                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('admin.news.update', $news) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            @if($news->image_path)
                                <div class="mb-2">
                                    <img src="{{ Storage::url($news->image_path) }}" alt="Current Image" class="h-32 w-auto object-cover rounded">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="source" class="block mt-1 w-full" type="text" name="source" :value="old('source', $news->source)" placeholder="Contoh: Detik.com, Kompas" />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="video_url" class="block mt-1 w-full" type="url" name="video_url" :value="old('video_url', $news->video_url)" placeholder="https://youtube.com/watch?v=..." />
                        ...
                        <div class="mb-4 p-4 border rounded-lg bg-gray-50">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <x-text-input id="social_links_youtube" class="block mt-1 w-full" type="url" name="social_links[youtube]" :value="old('social_links.youtube', $news->social_links['youtube'] ?? '')" placeholder="https://youtube.com/@..." />
                                </div>
                                <div>
                                    <x-input-label for="social_links_tiktok" :value="__('TikTok URL')" />
                                    <x-text-input id="social_links_tiktok" class="block mt-1 w-full" type="url" name="social_links[tiktok]" :value="old('social_links.tiktok', $news->social_links['tiktok'] ?? '')" placeholder="https://tiktok.com/@..." />
                                </div>
                                <div>
                                    <x-input-label for="social_links_instagram" :value="__('Instagram URL')" />
                                    <x-text-input id="social_links_instagram" class="block mt-1 w-full" type="url" name="social_links[instagram]" :value="old('social_links.instagram', $news->social_links['instagram'] ?? '')" placeholder="https://instagram.com/..." />
                                </div>
                                <div>
                                    <x-input-label for="social_links_facebook" :value="__('Facebook URL')" />
                                    <x-text-input id="social_links_facebook" class="block mt-1 w-full" type="url" name="social_links[facebook]" :value="old('social_links.facebook', $news->social_links['facebook'] ?? '')" placeholder="https://facebook.com/..." />
                                </div>
                                <div>
                                    <x-input-label for="social_links_twitter" :value="__('Twitter/X URL')" />
                                    <x-text-input id="social_links_twitter" class="block mt-1 w-full" type="url" name="social_links[twitter]" :value="old('social_links.twitter', $news->social_links['twitter'] ?? '')" placeholder="https://twitter.com/..." />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="block mt-4 mb-6">
                            <label for="is_published" class="inline-flex items-center">
                                <input id="is_published" type="checkbox" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" name="is_published" value="1" {{ old('is_published', $news->is_published) ? 'checked' : '' }}>
